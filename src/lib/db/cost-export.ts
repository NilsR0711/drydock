 ...
 * Reports share one underlying job set (dated jobs matching the filter) so
 * their grand totals reconcile with each other and with the cost dashboard.
 */
