 ...
 * for the codex provider, otherwise the claude path. Used everywhere the
 * orchestrator spawns an agent (job runs, CI-fix resumes, review-feedback,
 * deployment healing, and issue decomposition) so a repo's configured agent
