...
- [035](adr/035-desktop-menu-bar-shell.md) — Native macOS menu-bar shell (Tauri) wrapping the dashboard + HTTP control endpoints (pause/drain) with a custom-header CSRF guard; separate crate, not in the npm package, Rust out of CI
