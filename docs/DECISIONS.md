...
- [035](adr/035-tracked-pr-babysitting.md) — Babysit arbitrary PRs added by URL (decoupled `tracked_prs` record + driver-loop sweep; auto-merge opt-in & owned-only; never touches fork branches)
